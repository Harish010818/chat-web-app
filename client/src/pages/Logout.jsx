        ...
        {isLargeScreen ? (
          <>
            ...
            <label
              ...
              className="absolute w-12 h-12 md:top-3 md:left-2 cursor-pointer group"
            >
              <div className="absolute left-15 top-2 z-10 bg-[var(--rich-black)] bg-opacity-70 text-[var(--homepage-white)] text-xs font-semibold px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                Profile
              </div>
            ...
            <div className="absolute w-12 h-12 md:top-20 md:left-1.5 cursor-pointer">
